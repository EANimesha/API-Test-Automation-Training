...
public class PetProject {
    ...
    public void testPostRequest(){
        ...
        Response response= given().header(Constants.HEADER_CONTENT_TYPE,Constants.HEADER_CONTENT_VAL_JSON).body(body).when()
                .post(Constants.BASE_URL_PETSTORE+Constants.ENDPOINT_PET);
        softAssert.assertEquals(response.getStatusCode(), 200, Constants.INVALID_CODE_TEXT);
        APIUtils.printResults(response);
        softAssert.assertAll();
    }
    ...
    public void testGetRequest(){
        ...
        //Todo - Print Response
        Response response= given().header(Constants.HEADER_CONTENT_TYPE,Constants.HEADER_CONTENT_VAL_JSON).when()
                .get(Constants.BASE_URL_PETSTORE+Constants.ENDPOINT_PET+Constants.PET_ID);
        softAssert.assertEquals(response.getStatusCode(), 200, Constants.INVALID_CODE_TEXT);
    ...
    public void testPutRequest(){
        ...
        Response response= given().header(Constants.HEADER_CONTENT_TYPE,Constants.HEADER_CONTENT_VAL_JSON).body(body).when()
                .put(Constants.BASE_URL_PETSTORE+Constants.ENDPOINT_PET);
        softAssert.assertEquals(response.getStatusCode(), 200, Constants.INVALID_CODE_TEXT);
        APIUtils.printResults(response);
        softAssert.assertAll();
    }
    ...
    public void testDeleteRequest(){
        ...
        //Todo - Print Response
        Response response= given().header(Constants.HEADER_CONTENT_TYPE,Constants.HEADER_CONTENT_VAL_JSON).when()
                .delete(Constants.BASE_URL_PETSTORE+Constants.ENDPOINT_PET+Constants.PET_ID);
        softAssert.assertEquals(response.getStatusCode(), 200, Constants.INVALID_CODE_TEXT);
        APIUtils.printResults(response);
        softAssert.assertAll();
    }
